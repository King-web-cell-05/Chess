...
namespace ChessUI
{
    ...
    public partial class PromotionMenu : UserControl
    {
        ...
        private void BishopImg_MouseDown(object sender, MouseEventArgs e)
        {
            PieceSelected?.Invoke(PieceType.Bishop);
        }

        private void RookImg_MouseDown(object sender, MouseEventArgs e)
        {
            PieceSelected?.Invoke(PieceType.Rook);
        }

        private void KnightImg_MouseDown(object sender, MouseEventArgs e)
        {
